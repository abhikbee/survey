...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		$sql = "UPDATE survey SET choicequestion17='".$choice."' WHERE identifier='".$identifier."';";
			if (mysql_query($sql)) {
    ...
    <form name="rewardPreferred" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      <div class="cf">
        <div class="choiceBlock choiceA">
          ...
          <p>Choice 1 to avail $9.75 and one star under Rewards Program B</p>
        ...
        <div class="choiceBlock choiceB">
          ...
          <p>Choice 2 to avail $9.75 and no star under Rewards Program B</p>
          <div class="choiceRadio">
