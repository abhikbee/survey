...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		$sql = "UPDATE survey SET choicequestion10='".$choice."' WHERE identifier='".$identifier."';";
			if (mysql_query($sql)) {	
				header('Location: introb.php');
			} else {
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span></span>&nbsp;&nbsp;PART 2 of 3</div>
    ...
    <form name="rewardPreferred" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      <div class="cf">
        <div class="choiceBlock choiceA">
          ...
          <p>Choice 1 to avail $10.00 and one star under Rewards Program A</p>
        ...
        <div class="choiceBlock choiceB">
          ...
          <p>Choice 2 to avail $10.00 and no stars under Rewards Program A</p>
          <div class="choiceRadio">
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:45%"></span></div>
  </div>
</section>
