...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase Chocolate Croissant, Grande Skinny Latte for $6.70. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?><?php echo $erMsg1; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item111.jpg"> <span class="prdName"><span>Grande Mocha Frappuccino</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item112.jpg"> <span class="prdName"><span>Chocolate Croissant</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item113.jpg"> <span class="prdName"><span>Grande Skinny Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?><?php echo $erMsg4; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item114.jpg"> <span class="prdName"><span>Blueberry Scone</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra1"><span class="fillBG" style="height:83.3%"></span></div>
  </div>
</section>
