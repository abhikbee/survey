    ...
    <form name="rewardAForm" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      ...
      <div class="cf">
        <div class="rewardAForm">
          ...
          <div class="scaleForm">
            <div class="formRow">
              <h3>Under Rewards Program A, you feel encouraged to make additional purchases. </h3>
              <ul class="scaleUL">
                <li>
                  <input class="icheck" type="radio" name="asg1" value="Strongly Disagree" id="asg11" <?php if ($asg1 == 1) { echo 'checked';} ?>>
                  <label for="asg11"><span class="value">1</span>Strongly Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg1" value="Disagree" id="asg12" <?php if ($asg1 == 2) { echo 'checked';} ?>>
                  <label for="asg12"><span class="value">2</span>Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg1" value="Neutral" id="asg13" <?php if ($asg1 == 3) { echo 'checked';} ?>>
                  <label for="asg13"><span class="value">3</span>Neutral</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg1" value="Agree" id="asg14" <?php if ($asg1 == 4) { echo 'checked';} ?>>
                  <label for="asg14"><span class="value">4</span>Agree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg1" value="Strongly Agree" id="asg15" <?php if ($asg1 == 5) { echo 'checked';} ?>>
            ...
            <div class="formRow">
              ...
              <ul class="scaleUL">
                <li>
                  <input class="icheck" type="radio" name="asg2" value="Strongly Disagree" id="asg21" <?php if ($asg2 == 1) { echo 'checked';} ?>>
                  <label for="asg21"><span class="value">1</span>Strongly Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg2" value="Disagree" id="asg22" <?php if ($asg2 == 2) { echo 'checked';} ?>>
                  <label for="asg22"><span class="value">2</span>Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg2" value="Neutral" id="asg23" <?php if ($asg2 == 3) { echo 'checked';} ?>>
                  <label for="asg23"><span class="value">3</span>Neutral</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg2" value="Agree" id="asg24" <?php if ($asg2 == 4) { echo 'checked';} ?>>
                  <label for="asg24"><span class="value">4</span>Agree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg2" value="Strongly Agree" id="asg25" <?php if ($asg2 == 5) { echo 'checked';} ?>>
            ...
            <div class="formRow">
              ...
              <ul class="scaleUL">
                <li>
                  <input class="icheck" type="radio" name="asg3" value="Strongly Disagree" id="asg31" <?php if ($asg3 == 1) { echo 'checked';} ?>>
                  <label for="asg31"><span class="value">1</span>Strongly Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg3" value="Disagree" id="asg32" <?php if ($asg3 == 2) { echo 'checked';} ?>>
                  <label for="asg32"><span class="value">2</span>Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg3" value="Neutral" id="asg33" <?php if ($asg3 == 3) { echo 'checked';} ?>>
                  <label for="asg33"><span class="value">3</span>Neutral</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg3" value="Agree" id="asg34" <?php if ($asg3 == 4) { echo 'checked';} ?>>
                  <label for="asg34"><span class="value">4</span>Agree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg3" value="Strongly Agree" id="asg35" <?php if ($asg3 == 5) { echo 'checked';} ?>>
            ...
            <div class="formRow">
              ...
              <ul class="scaleUL">
                <li>
                  <input class="icheck" type="radio" name="asg4" value="Strongly Disagree" id="asg41" <?php if ($asg4 == 1) { echo 'checked';} ?>>
                  <label for="asg41"><span class="value">1</span>Strongly Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg4" value="Disagree" id="asg42" <?php if ($asg4 == 2) { echo 'checked';} ?>>
                  <label for="asg42"><span class="value">2</span>Disagree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg4" value="Neutral" id="asg43" <?php if ($asg4 == 3) { echo 'checked';} ?>>
                  <label for="asg43"><span class="value">3</span>Neutral</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg4" value="Agree" id="asg44" <?php if ($asg4 == 4) { echo 'checked';} ?>>
                  <label for="asg44"><span class="value">4</span>Agree</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg4" value="Strongly Agree" id="asg45" <?php if ($asg4 == 5) { echo 'checked';} ?>>
            ...
            <div class="formRow">
              ...
              <ul class="scaleUL">
                <li>
                  <input class="icheck" type="radio" name="asg5" value="Not at all Happy" id="asg51" <?php if ($asg5 == 1) { echo 'checked';} ?>>
                  <label for="asg51"><span class="value">1</span>Not at all Happy</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg5" value="Not Very Happy" id="asg52" <?php if ($asg5 == 2) { echo 'checked';} ?>>
                  <label for="asg52"><span class="value">2</span>Not Very Happy</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg5" value="Neutral" id="asg53" <?php if ($asg5 == 3) { echo 'checked';} ?>>
                  <label for="asg53"><span class="value">3</span>Neutral</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg5" value="Somewhat Happy" id="asg54" <?php if ($asg5 == 4) { echo 'checked';} ?>>
                  <label for="asg54"><span class="value">4</span>Somewhat Happy</label>
                </li>
                <li>
                  <input class="icheck" type="radio" name="asg5" value="Very Happy" id="asg55" <?php if ($asg5 == 5) { echo 'checked';} ?>>
