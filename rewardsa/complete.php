...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		$sql = "UPDATE survey SET rewards_a_product = '".$selected."' WHERE identifier='".$identifier."';";
			if (mysql_query($sql)) {
...
<section class="slideBlock">
  ...
  <div class="container">
    ...
    <div class="question" id="questionDone">
      ...
      <p>You’ve collected 12 stars – the next one's us! Please select an item to redeem and click the 'Continue' button to answer some questions about Rewards Program A.</p>	
