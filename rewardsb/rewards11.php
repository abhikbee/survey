...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase a Chocolate Croissant, Grande Skinny Latte for $6.70. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
