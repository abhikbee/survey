...
<section class="slideBlock" id="rewardsB">
  <div class="container">
    <div class="question" id="question12">
      <p>You visit Starbucks and purchased a Grande Skinny White Latte, Grande Latte costing $7.4. As a member of Starbucks Rewards A, you can get any food or drink item free with 125 stars. Please click on the items that you purchased to collect stars under Rewards A.</p>
      <div class="cf">
        <div class="rewardsAStar">
          <ul>
            ...
            <li class="star10 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star10 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star11 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star11 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star11 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star11 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
            <li class="star11 active"><img src="<?php echo $siteurl; ?>images/star.png" alt="star"></li>
        ...
        <div class="rewardsProducts">
          <div class="productBlock"> <img src="<?php echo $siteurl; ?>images/prd19.jpg"></div>
          <div class="productBlock"> <img src="<?php echo $siteurl; ?>images/prd20.jpg"></div>
          <div class="totalSpend">Spend = $62.50</div>
        </div>
      </div>
      <a href="rewardscomplete.php" class="continueBtn disable">Continue</a> </div>
  </div>
