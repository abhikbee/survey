...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase a Grande Iced Coffee, Venti Dark Roast Coffee for $4.80. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
