...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase a Grande Latte for $3.45. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?><?php echo $erMsg1; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item41.jpg"> <span class="prdName"><span>Tall Pike Place Brewed Coffee</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?><?php echo $erMsg2; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item42.jpg"> <span class="prdName"><span>Grande Chai Tea Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item43.jpg"> <span class="prdName"><span>Grande Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?><?php echo $erMsg4; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item44.jpg"> <span class="prdName"><span>Ham and Swiss Panini</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra2"><span class="fillBG" style="height:24.99%"></span></div>
  </div>
</section>
