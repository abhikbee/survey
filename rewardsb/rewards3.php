...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase Venti White Mocha, Venti Iced Coffee for $7.60. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item31.jpg"> <span class="prdName"><span>Venti White Mocha</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?><?php echo $erMsg2; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item32.jpg"> <span class="prdName"><span>Grande Pumpkin Spice Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item33.jpg"> <span class="prdName"><span>Venti Iced Coffee</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?><?php echo $erMsg4; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item34.jpg"> <span class="prdName"><span>Venti Dark Roast Coffee</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra2"><span class="fillBG" style="height:16.66%"></span></div>
  </div>
</section>
