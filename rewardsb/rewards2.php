      ...
      <div class="cf">
        <div class="rewardsAStar">
          <ul>
            ...
            <li class="star1 active"><img src="../images/star.png" alt="star"></li>
            <li class="star1 active"><img src="../images/star.png" alt="star"></li>
            <li class="star2"><img src="../images/star.png" alt="star"></li>
            <li class="star2"><img src="../images/star.png" alt="star"></li>
            <li class="star2"><img src="../images/star.png" alt="star"></li>
            <li class="star2"><img src="../images/star.png" alt="star"></li>
            <li class="star2"><img src="../images/star.png" alt="star"></li>
        ...
        <div class="rewardsProducts">
          <div class="productBlock"> <img src="../images/prd2.jpg"></div>
          <div class="productBlock"> <img src="../images/prd3.jpg"></div>
          <div class="productBlock"> <img src="../images/prd4.jpg"></div>
