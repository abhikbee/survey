...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase Grande Mocha, Grande Caramel Frappuccino, Blueberry Scone for $10.85. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item21.jpg"> <span class="prdName"><span>Grande Mocha</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item22.jpg"> <span class="prdName"><span>Grande Caramel Frappuccino</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?><?php echo $erMsg3; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item23.jpg"> <span class="prdName"><span>Grande Iced Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item24.jpg"> <span class="prdName"><span>Blueberry Scone</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra2"><span class="fillBG" style="height:8.33%"></span></div>
  </div>
</section>
