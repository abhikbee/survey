...
$btnContinue= '<a href="rewards10.php" class="continueBtn">Continue</a>';
...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase a Grande Mocha for $3.95. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?><?php echo $erMsg1; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item91.jpg"> <span class="prdName"><span>Grande Pumpkin Spice Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?><?php echo $erMsg2; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item92.jpg"> <span class="prdName"><span>Venti Iced Coffee</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?><?php echo $erMsg3; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item93.jpg"> <span class="prdName"><span>Grande Chai Tea Latte</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item94.jpg"> <span class="prdName"><span>Grande Mocha</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra2"><span class="fillBG" style="height:66.64%"></span></div>
  </div>
</section>
