...
<section class="slideBlock" id="rewardsB">
  <div class="container">
    <div class="question" id="question10">
      <p>You visit Starbucks and purchased a Tall Freshly Brewed Coffee costing $2.35. As a member of Starbucks Rewards A, you can get any food or drink item free with 125 stars. Please click on the items that you purchased to collect stars under Rewards A.</p>
      <div class="cf">
        ...
        <div class="rewardsProducts">
          <div class="productBlock prdCenter"> <img src="<?php echo $siteurl; ?>images/prd16.jpg"></div>
          <div class="totalSpend">Spend = $50.00</div>
        </div>
      </div>
      <a href="rewards11.php" class="continueBtn disable">Continue</a> </div>
  </div>
