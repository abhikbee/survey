...
$btnContinue= '<a href="rewards9.php" class="continueBtn">Continue</a>';
...
<section class="slideBlock" id="buyNowSection">
  ...
  <div class="container">
    <div class="question" id="question1">
      ...
      <?php } else { ?>
      <p>During your next visit to Starbucks, you purchase Venti Iced Coffee, Grande Chai Tea Latte for $6.90. Please click on your purchased items and select ‘Buy Now’ to collect your stars</p>
      <?php } ?>
      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
        <div class="cf">
          ...
          <div class="rewardsProducts">
            <div class="productBlock <?php if (!empty($check1)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item81.jpg"> <span class="prdName"><span>Venti Iced Coffee</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check2)) { echo 'activeDiv';}?><?php echo $erMsg2; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item82.jpg"> <span class="prdName"><span>Grande Caramel Frappuccino</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check3)) { echo 'activeDiv';}?><?php echo $erMsg3; if ($setContinue) echo 'gray'; ?>"> <img src="<?php echo $siteurl; ?>images/item83.jpg"> <span class="prdName"><span>Venti Iced Coffee</span></span>
            ...
            <div class="productBlock  <?php if (!empty($check4)) { echo 'activeDiv';}?>"> <img src="<?php echo $siteurl; ?>images/item84.jpg"> <span class="prdName"><span>Grande Chai Tea Latte</span></span>
  ...
  <div class="progressBar">
    <div class="progressStep ra2"><span class="fillBG" style="height:58.31%"></span></div>
  </div>
</section>
