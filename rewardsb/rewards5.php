...
<section class="slideBlock" id="rewardsB"><img src="<?php echo $siteurl; ?>images/glass.png" alt="" class="glass">
  <div class="container">
    ...
    <div class="question" id="question5">
      <p>You visit Starbucks and purchased a Grande Latte costing $3.45. As a member of Starbucks Rewards A, you can get any food or drink item free with 125 stars. Please click on the items that you purchased to collect stars under Rewards A.</p>
      <div class="cf">
        ...
        <div class="rewardsProducts">
          <div class="productBlock prdCenter"> <img src="<?php echo $siteurl; ?>images/prd8.jpg"></div>
          <div class="totalSpend">Spend = $27.90</div>
        </div>
      </div>
      <a href="rewards6.php" class="continueBtn disable">Continue</a> </div>
  </div>
