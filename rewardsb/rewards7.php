...
<section class="slideBlock" id="rewardsB">
  <div class="container">
    <div class="question" id="question7">
      <p>You visit Starbucks and purchased a Grande Iced Coffee, Tall Chai Tea Latte costing $5.70. As a member of Starbucks Rewards A, you can get any food or drink item free with 125 stars. Please click on the items that you purchased to collect stars under Rewards A.</p>
      <div class="cf">
        ...
        <div class="rewardsProducts">
          <div class="productBlock"> <img src="<?php echo $siteurl; ?>images/prd11.jpg"></div>
          <div class="productBlock"> <img src="<?php echo $siteurl; ?>images/prd12.jpg"></div>
          <div class="totalSpend">Spend = $37.50</div>
        </div>
      </div>
      <a href="rewards8.php" class="continueBtn disable">Continue</a> </div>
  </div>
