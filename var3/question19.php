...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion19='".$choice."', question19time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  <div class="container">
    ...
    <p class="desc">You sign up for the program</p>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:56.16%"></span></div>
  </div>
</section>
