...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion10='".$choice."', question10time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  <div class="container">
    ...
    <p class="desc">You purchase a bakery item</p>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:28.08%"></span></div>
  </div>
</section>
