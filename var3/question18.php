...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion18='".$choice."', question18time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  <div class="container">
    ...
    <p class="desc">You visit a store 5 times in a week</p>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:53.04%"></span></div>
  </div>
</section>
