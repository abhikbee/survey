...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion15='".$choice."', question15time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:43.68%"></span></div>
  </div>
</section>
