...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion31='".$choice."', question31time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
				header('Location: question32.php');
			} else {
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  <div class="container">
    ...
    <p class="desc">You make 5 purchases in a week</p>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:93.6%"></span></div>
  </div>
</section>
