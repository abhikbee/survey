...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($hasError)) {
		...
		$sql1 = "UPDATE var3 SET varquestion7='".$choice."', question7time='".$time."'  WHERE identifier='".$identifier."';";
			if (mysql_query($sql1)) {	
...
<div class="variableInfo"><span class="active"></span><span class="active"></span><span class="active"></span>&nbsp;&nbsp;PART 3 of 3</div>
  <div class="container">
    ...
    <p class="desc">You visit any store at least twice in one day</p>
    ...
    <form name="rewardPreferred" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
      <div class="cf">
        <div class="varBlock optionA">
          <div class="offerBlock">5 bonus stars</div>
        ...
        <div class="varBlock optionB">
          <div class="offerBlock">30% discount on your bevarage</div>
  ...
  <div class="progressBar">
    <div class="progressStep ra5"><span class="fillBG" style="height:18.72%"></span></div>
  </div>
</section>
